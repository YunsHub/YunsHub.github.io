...
mermade: true
date: 2022-11-30 21:55:00 +0900
categories: [algorithm, Baekjoon]
tags: [algorithm, java, 백준, 백준 1504, 백준 1504 특정한 최단 경로, 다익스트라, djikstra] # TAG names should always be lowercase
---
>백준 1504 특정한 최단 경로
...
## 문제
---
![백준](/assets/img/BOJ/1504.PNG)

## 풀이
---
- 1번 정점에서 임의로 주어진 두 정점을 반드시 통과 후 N번 정점까지의 최단 경로를 구하는 문제이다.
- ```다익스트라```알고리즘을 사용하여 1 -> v1 -> v2 -> N, 1 -> v2 -> v1 -> N 2가지의 경우의 수를 구하여 더 작은 경로를 출력한다.
- d배열을 최대값으로 초기화 시켜주어 경로가 없다면 최대값이 반환되도록 하여 -1을 출력한다.
- 
...
## 결과
---
![백준](/assets/img/BOJ/1504_result.PNG)